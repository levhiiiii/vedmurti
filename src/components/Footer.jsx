          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-4 py-2 border border-white placeholder-white rounded-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <button className="bg-green-600 border-white border hover:bg-green-700 text-white px-6 py-2 rounded-md transition-colors">
                Subscribe
              </button>
            </div>
          </div>
